...
void main() {
  ...
  test('DLC Query test', () {
    ...
    final DLCEntity updatedEntity = DLCEntity(
      id: 1,
      name: 'name2',
      releaseYear: 1996,
      coverFilename: 'coverFilename',
      baseGame: 2,
      firstFinishDate: DateTime.now().subtract(const Duration(days: 6)),
    );
  ...
  test('Game Query test', () {
    ...
    final GameEntity updatedEntity = GameEntity(
      id: 1,
      name: 'name2',
      edition: 'edition2',
      releaseYear: 2010,
      ...
      isBackup: true,
      firstFinishDate: DateTime.now().subtract(const Duration(days: 6)),
      totalTime: const Duration(minutes: 90),
    );
  ...
  test('Platform Query test', () {
    ...
    const PlatformEntity updatedEntity = PlatformEntity(
      id: 1,
      name: 'name2',
      iconFilename: 'iconFilename',
      type: 'type2',
  ...
  test('Purchase Query test', () {
    ...
    final PurchaseEntity updatedEntity = PurchaseEntity(
      id: 1,
  ...
  test('Store Query test', () {
    ...
    const StoreEntity updatedEntity =
        StoreEntity(id: 1, name: 'name2', iconFilename: 'iconFilename');
  ...
  test('System Query test', () {
    ...
    const SystemEntity updatedEntity = SystemEntity(
      id: 1,
      name: 'name2',
      iconFilename: 'iconFilename',
      generation: 1,
  ...
  test('Purchase Type Query test', () {
    ...
    const PurchaseTypeEntity updatedEntity =
        PurchaseTypeEntity(id: 1, name: 'name2');
  ...
  test('DLC Finish Query test', () {
    ...
    final DLCFinishEntity updatedEntity = DLCFinishEntity(
      dlcId: 1,
  ...
  test('Game Finish Query test', () {
    ...
    final GameFinishEntity updatedEntity = GameFinishEntity(
      gameId: 1,
      dateTime: DateTime.now().subtract(const Duration(days: 6)),
    );
  ...
  test('Game Time Log Query test', () {
    ...
    final GameTimeLogEntity updatedEntity = GameTimeLogEntity(
      gameId: 1,
      dateTime: DateTime.now().subtract(const Duration(days: 6)),
