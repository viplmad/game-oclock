...
class GameWithLogs extends Equatable implements Comparable<GameWithLogs> {
  ...
  Set<DateTime> get logDates => timeLogs
      .map<DateTime>((GameTimeLog log) => log.dateTime.toDate())
      .toSet();

  Duration get totalTime => timeLogs.fold<Duration>(
        const Duration(),
  ...
  @override
  int compareTo(GameWithLogs other) =>
      other.totalTime.compareTo(totalTime); // Longer total time first
}
