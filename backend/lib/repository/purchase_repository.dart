...
import './query/query.dart'
    show
        PurchaseQuery,
        PurchaseTypeRelationQuery,
        GamePurchaseRelationQuery,
        DLCPurchaseRelationQuery;
...
class PurchaseRepository extends ItemRepository<PurchaseEntity, PurchaseID> {
  const PurchaseRepository(
    ...
    ImageConnector? imageConnector,
          ...
          itemConnector,
          imageConnector,
          recordName: PurchaseEntityData.table,
        );

  @override
  PurchaseEntity entityFromMap(Map<String, Object?> map) =>
      PurchaseEntity.fromMap(map);
  @override
  PurchaseID idFromMap(Map<String, Object?> map) =>
      PurchaseEntity.idFromMap(map);
  ...
  Future<Object?> relatePurchaseType(
  ...
  Future<List<PurchaseEntity>> findAllWithView(
  ...
  Future<List<PurchaseEntity>> findFirstWithView(
    PurchaseView purchaseView,
    int limit,
    int? year,
  ) {
    final Query query =
        PurchaseQuery.selectFirstInView(purchaseView, limit, year);
    return readItemList(
      query: query,
    );
  }

  Future<List<PurchaseEntity>> findAllWithYearView(
    PurchaseView purchaseView,
    int year, [
    int? page,
  ]) {
  ...
  Future<List<PurchaseEntity>> findAllFromGame(GameID id) {
    final Query query =
        GamePurchaseRelationQuery.selectAllPurchasesByGameId(id);
    return readItemList(
      query: query,
    );
  }
  ...
  Future<List<PurchaseEntity>> findAllFromPurchaseType(PurchaseTypeID id) {
    final Query query =
        PurchaseTypeRelationQuery.selectAllPurchasesByTypeId(id);
    return readItemList(
      query: query,
    );
  }
  ...
  //#region UPDATE
  @override
  Future<PurchaseEntity> update(
    PurchaseEntity entity,
    PurchaseEntity updatedEntity,
  ) {
  ...
  Future<Object?> unrelatePurchaseType(
    PurchaseID purchaseId,
    PurchaseTypeID typeId,
  ) {
    final Query query =
        PurchaseTypeRelationQuery.deleteById(purchaseId, typeId);
    return itemConnector.execute(query);
  }
  //#endregion DELETE

  //#region SEARCH
  Future<List<PurchaseEntity>> findFirstByDescription(
    String description,
    int limit,
  ) {
    final Query query =
        PurchaseQuery.selectFirstByDescriptionLike(description, limit);
    return readItemList(
      query: query,
    );
  }

  Future<List<PurchaseEntity>> findFirstWithViewByDescription(
    PurchaseView view,
    String description,
    int limit,
    int? year,
  ) {
    final Query query = PurchaseQuery.selectFirstInViewByDescriptionLike(
      view,
      description,
      limit,
      year,
