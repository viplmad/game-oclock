...
import 'package:backend/entity/entity.dart'
    show
        GameEntityData,
        GameGeneralStatisticsEntity,
        GameStatisticsEntity,
        GameView,
        GameYearStatisticsEntity;
...
class GameStatisticsRepository extends StatisticsRepository {
  ...
  Future<GameGeneralStatisticsEntity> findGameStatistics(
    ...
    final GameStatisticsEntity stats =
        GameStatisticsEntity.fromMap(gameMap, finishMap, timeLogMap);
    ...
    final Query countByReleaseYearQuery =
        GameQuery.selectStatisticsCountByReleaseYear(
      view,
      minReleaseYear,
      maxReleaseYear,
      year,
    ...
    final Query countByRatingQuery =
        GameQuery.selectStatisticsCountByRating(view, year);
    final Map<String, Object?> countByRatingMap = await readItemRaw(
      query: countByRatingQuery,
    );

    final Query averageRatingByFinishYearQuery =
        GameQuery.selectStatisticsAvgRatingByFinishYear(
      view,
      minFinishYear,
      maxFinishYear,
      year,
    ...
    final Query countByFinishYearQuery =
        GameQuery.selectStatisticsCountByFinishYear(
      view,
      minFinishYear,
      maxFinishYear,
      year,
    ...
    final Query logSumByFinishYearQuery =
        GameQuery.selectStatisticsSumTimeByFinishYear(
      view,
      minFinishYear,
      maxFinishYear,
      year,
    ...
    return GameGeneralStatisticsEntity.fromMap(
      stats,
      countByReleaseYearMap,
      countByRatingMap,
      averageRatingByFinishYearMap,
      countByFinishYearMap,
      logSumByFinishYearMap,
    );
  }

  Future<GameYearStatisticsEntity> findGameStatisticsFinishYear(
    GameView view,
    int finishYear,
    int? year,
  ) async {
    final Query gameQuery =
        GameQuery.selectStatisticsWithFinishYear(view, finishYear, year);
    final Map<String, Object?> gameMap = await readItemRaw(
      query: gameQuery,
    );

    final Query finishQuery =
        GameQuery.selectFinishStatisticsWithFinishYear(view, finishYear, year);
    final Map<String, Object?> finishMap = await readItemRaw(
      query: finishQuery,
    );

    final Query timeLogQuery =
        GameQuery.selectTimeLogStatisticsWithFinishYear(view, finishYear, year);
    final Map<String, Object?> timeLogMap = await readItemRaw(
      query: timeLogQuery,
    );
    ...
    final Query countByReleaseYearQuery =
        GameQuery.selectStatisticsCountByReleaseYearWithFinishYear(
      view,
      finishYear,
      minReleaseYear,
      maxReleaseYear,
    ...
    final Query countByRatingQuery =
        GameQuery.selectStatisticsCountByRatingWithFinishYear(
      view,
      finishYear,
      year,
    );
    ...
    final Query timeLogSumByMonthQuery =
        GameQuery.selectStatisticsSumTimeByMonthWithFinishYear(
      view,
      finishYear,
      year,
    );
    ...
    return GameYearStatisticsEntity.fromMap(
      stats,
      countByReleaseYearMap,
      countByRatingMap,
