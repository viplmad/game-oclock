...
import 'package:backend/entity/entity.dart'
    show GameFinishEntity, GameFinishID, GameID, GameFinishEntityData;

import './query/query.dart' show GameFinishQuery;
import 'item_repository.dart';

class GameFinishRepository
    extends ItemRepository<GameFinishEntity, GameFinishID> {
  const GameFinishRepository(
    ItemConnector itemConnector,
    ImageConnector? imageConnector,
  ) : super(
          itemConnector,
          imageConnector,
          recordName: GameFinishEntityData.table,
        );

  @override
  GameFinishEntity entityFromMap(Map<String, Object?> map) =>
      GameFinishEntity.fromMap(map);
  @override
  GameFinishID idFromMap(Map<String, Object?> map) =>
      GameFinishEntity.idFromMap(map);
  ...
  //#region UPDATE
  @override
  Future<GameFinishEntity> update(
