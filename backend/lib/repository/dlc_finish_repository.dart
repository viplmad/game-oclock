...
class DLCFinishRepository extends ItemRepository<DLCFinishEntity, DLCFinishID> {
  const DLCFinishRepository(
    ItemConnector itemConnector,
    ImageConnector? imageConnector,
  ) : super(
          itemConnector,
          imageConnector,
          recordName: DLCFinishEntityData.table,
        );

  @override
  DLCFinishEntity entityFromMap(Map<String, Object?> map) =>
      DLCFinishEntity.fromMap(map);
  @override
  DLCFinishID idFromMap(Map<String, Object?> map) =>
      DLCFinishEntity.idFromMap(map);
