...
class GameTimeLogQuery {
  ...
  static Query deleteById(GameTimeLogID id) {
    final Query query = FluentQuery.delete().from(GameTimeLogEntityData.table);
  ...
  static Query selectById(GameTimeLogID id) {
    final Query query = FluentQuery.select().from(GameTimeLogEntityData.table);
  ...
  static Query selectAllByGame(GameID id) {
    final Query query =
        FluentQuery.select().from(GameTimeLogEntityData.table).where(
