...
import 'package:backend/entity/entity.dart'
    show GameTagEntity, GameTagEntityData, GameTagID, GameTagView;
...
class GameTagQuery {
  ...
  static Query deleteById(GameTagID id) {
    final Query query = FluentQuery.delete().from(GameTagEntityData.table);
  ...
  static Query selectById(GameTagID id) {
    final Query query = FluentQuery.select().from(GameTagEntityData.table);
  ...
  static Query selectFirstInView(GameTagView view, int limit) {
    final Query query =
        FluentQuery.select().from(GameTagEntityData.table).limit(limit);
