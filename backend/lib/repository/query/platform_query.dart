...
import 'package:backend/entity/entity.dart'
    show PlatformEntity, PlatformEntityData, PlatformID, PlatformView;
...
class PlatformQuery {
  ...
  static Query deleteById(PlatformID id) {
    final Query query = FluentQuery.delete().from(PlatformEntityData.table);
  ...
  static Query selectById(PlatformID id) {
    final Query query = FluentQuery.select().from(PlatformEntityData.table);
  ...
  static Query selectFirstInView(PlatformView view, int limit) {
    final Query query =
        FluentQuery.select().from(PlatformEntityData.table).limit(limit);
  ...
  static void addFields(Query query) {
    ...
    query.field(
      PlatformEntityData.iconField,
      type: String,
      table: PlatformEntityData.table,
    );
    query.field(
      PlatformEntityData.typeField,
      type: String,
      table: PlatformEntityData.table,
    );
  }
