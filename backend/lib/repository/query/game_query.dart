...
class GameQuery {
  ...
  static Query deleteById(GameID id) {
    final Query query = FluentQuery.delete().from(GameEntityData.table);
  ...
  static Query selectById(GameID id) {
    final Query query = FluentQuery.select().from(GameEntityData.table);
  ...
  static Query selectFirstInView(GameView view, int limit, [int? year]) {
    final Query query =
        FluentQuery.select().from(GameEntityData.table).limit(limit);
  ...
  static Query selectAllOwnedInView(GameView view, [int? year, int? page]) {
    ...
    final Query countGamePurchaseQuery = FluentQuery.select()
        .field(
  ...
  static Query selectFirstInViewByNameLike(
    GameView view,
    String name,
    int limit, [
    int? year,
  ...
  static Query selectStatistics(GameView view, [int? year]) {
    final Query query = FluentQuery.select()
        .field(
          ...
          table: GameEntityData.table,
          function: FunctionType.count,
          alias: GameStatisticsData.countField,
        )
        .field(
          ...
          alias: GameStatisticsData.ratingSumField,
        )
        .field(
          ...
          alias: GameStatisticsData.minReleaseYearField,
        )
        .field(
          GameEntityData.releaseYearField,
          type: int,
          ...
          alias: GameStatisticsData.maxReleaseYearField,
        )
        .fieldSubquery(
          _countStatusQuery(view, GameEntityData.lowPriorityValue, year),
          alias: GameStatisticsData.lowPriorityCountField,
        )
        .fieldSubquery(
          _countStatusQuery(view, GameEntityData.nextUpValue, year),
          alias: GameStatisticsData.nextUpCountField,
        )
        .fieldSubquery(
          _countStatusQuery(view, GameEntityData.playingValue, year),
          alias: GameStatisticsData.playingCountField,
        )
        .fieldSubquery(
          _countStatusQuery(view, GameEntityData.playedValue, year),
          alias: GameStatisticsData.playedCountField,
        )
        .from(GameEntityData.table);
  ...
  static Query selectStatisticsWithFinishYear(
    GameView view,
    int finishYear, [
    int? year,
  ]) {
    final Query query = FluentQuery.select()
        ...
        .fieldSubquery(
          _countStatusQueryWithFinishYear(
            view,
            finishYear,
            GameEntityData.lowPriorityValue,
            year,
          ),
          alias: GameStatisticsData.lowPriorityCountField,
        )
  ...
  static Query selectFinishStatistics(GameView view, [int? year]) {
    final Query query = FluentQuery.select()
        .field(
          ...
          table: GameFinishEntityData.table,
          function: FunctionType.count,
          alias: GameStatisticsData.finishCountField,
        )
        .field(
          GameFinishEntityData.dateField,
          type: DateTime,
          table: GameFinishEntityData.table,
          function: FunctionType.min,
          alias: GameStatisticsData.minFinishDateField,
        )
        .field(
          GameFinishEntityData.dateField,
          type: DateTime,
          table: GameFinishEntityData.table,
          function: FunctionType.max,
          alias: GameStatisticsData.maxFinishDateField,
        )
  ...
  static Query selectFinishStatisticsWithFinishYear(
    GameView view,
    int finishYear, [
    int? year,
  ]) {
  ...
  static Query selectTimeLogStatistics(GameView view, [int? year]) {
    final Query query = FluentQuery.select()
        .field(
          ...
          function: FunctionType.sum,
          alias: GameStatisticsData.timeLogSumField,
        )
    ...
    query.join(
      ...
      null,
      GameEntityData.idField,
      GameTimeLogEntityData.table,
      GameTimeLogEntityData.gameField,
    );
    _completeView(query, view, year, skipOrder: true);
  ...
  static Query selectTimeLogStatisticsWithFinishYear(
    GameView view,
    int finishYear, [
    int? year,
  ]) {
  ...
  static Query selectStatisticsCountByReleaseYear(
    GameView view,
    int minReleaseYear,
    int maxReleaseYear, [
    int? year,
    ...
    for (int releaseYear = minReleaseYear;
        releaseYear <= maxReleaseYear;
        releaseYear++) {
      final Query releaseYearCountQuery = FluentQuery.select()
          .field(
            GameEntityData.idField,
            type: int,
            table: GameEntityData.table,
  ...
  static Query selectStatisticsCountByRating(GameView view, [int? year]) {
    ...
    for (int rating = 1; rating <= 10; rating++) {
      final Query countQuery = FluentQuery.select()
          .field(
            GameEntityData.idField,
            type: int,
            table: GameEntityData.table,
  ...
  static Query selectStatisticsAvgRatingByFinishYear(
    GameView view,
    int minFinishYear,
    int maxFinishYear, [
    int? year,
    ...
    for (int finishYear = minFinishYear;
        finishYear <= maxFinishYear;
        finishYear++) {
      final Query ratingAvgQuery = FluentQuery.select()
          .field(
            GameEntityData.ratingField,
            type: double,
            table: GameEntityData.table,
            function: FunctionType.average,
          )
          .from(GameEntityData.table)
          .join(
            GameFinishEntityData.table,
  ...
  static Query selectStatisticsCountByFinishYear(
    GameView view,
    int minFinishYear,
    int maxFinishYear, [
    int? year,
  ...
  static Query selectStatisticsSumTimeByFinishYear(
    GameView view,
    int minFinishYear,
    int maxFinishYear, [
    int? year,
    ...
    for (int finishYear = minFinishYear;
        finishYear <= maxFinishYear;
        finishYear++) {
      final Query timeSumQuery = FluentQuery.select()
          .field(
            GameTimeLogEntityData.timeField,
            type: Duration,
            table: GameTimeLogEntityData.table,
  ...
  static Query selectStatisticsCountByRatingWithFinishYear(
    GameView view,
    int finishYear, [
    int? year,
  ]) {
  ...
  static Query selectStatisticsCountByReleaseYearWithFinishYear(
    GameView view,
    int finishYear,
    int minReleaseYear,
    int maxReleaseYear, [
  ...
  static Query selectStatisticsSumTimeByMonthWithFinishYear(
    GameView view,
    int finishYear, [
    int? year,
  ]) {
    ...
    for (int month = DateTime.january;
  ...
  static Query _countStatusQueryWithFinishYear(
    GameView view,
    int finishYear,
    String status, [
    int? year,
  ...
  static void addFields(Query query) {
    ...
    final Query firstFinishQuery = FluentQuery.select()
        .field(
          GameFinishEntityData.dateField,
          type: DateTime,
          table: GameFinishEntityData.table,
    ...
    query.fieldSubquery(
      firstFinishQuery,
      alias: GameEntityData.firstFinishDateField,
    );

    final Query totalTimeQuery = FluentQuery.select()
        .field(
          GameTimeLogEntityData.timeField,
          type: Duration,
          table: GameTimeLogEntityData.table,
    ...
    switch (view) {
      ...
      case GameView.lastPlayed:
        query.where(
          ...
          GameEntityData.playingValue,
          table: GameEntityData.table,
          divider: DividerType.start,
        );
        query.orWhere(
          GameEntityData.statusField,
          GameEntityData.playedValue,
          table: GameEntityData.table,
          divider: DividerType.end,
        );

        if (!skipOrder) {
          final Query lastTimeLogQuery = FluentQuery.select()
              .field(
                GameTimeLogEntityData.dateTimeField,
                table: GameTimeLogEntityData.table,
                function: FunctionType.max,
      ...
      case GameView.lastFinished:
        ...
        if (!skipOrder) {
          final Query lastFinishQuery = FluentQuery.select()
              .field(
                GameFinishEntityData.dateField,
                table: GameFinishEntityData.table,
                function: FunctionType.max,
      ...
      case GameView.review:
        ...
        final Query finishCountInYearQuery = FluentQuery.select()
            .field(
              GameFinishEntityData.gameField,
              table: GameFinishEntityData.table,
              function: FunctionType.count,
        ...
        query.whereSubquery(
          finishCountInYearQuery,
          0,
          operator: OperatorType.greaterThan,
        );

        if (!skipOrder) {
          final Query firstFinishInYearQuery = FluentQuery.select()
              .field(
                GameFinishEntityData.dateField,
                table: GameFinishEntityData.table,
                function: FunctionType.min,
