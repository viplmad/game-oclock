...
class PurchaseTypeQuery {
  ...
  static Query deleteById(PurchaseTypeID id) {
    final Query query = FluentQuery.delete().from(PurchaseTypeEntityData.table);
  ...
  static Query selectById(PurchaseTypeID id) {
    final Query query = FluentQuery.select().from(PurchaseTypeEntityData.table);
  ...
  static Query selectFirstInView(PurchaseTypeView view, int limit) {
    final Query query =
        FluentQuery.select().from(PurchaseTypeEntityData.table).limit(limit);
  ...
  static Query selectFirstByNameLike(String name, int limit) {
    final Query query = FluentQuery.select()
        ...
        .where(
          PurchaseTypeEntityData.nameField,
          name,
          type: String,
          table: PurchaseTypeEntityData.table,
