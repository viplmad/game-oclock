...
class PlatformSystemRelationQuery {
  ...
  static Query deleteById(PlatformID platformId, SystemID systemId) {
    final Query query =
        FluentQuery.delete().from(PlatformSystemRelationData.table);
  ...
  static Query selectAllPlatformsBySystemId(SystemID id) {
    final Query query = FluentQuery.select()
        ...
        .join(
          PlatformSystemRelationData.table,
          null,
          PlatformSystemRelationData.platformField,
          PlatformEntityData.table,
          PlatformEntityData.idField,
        )
        .where(
          PlatformSystemRelationData.systemField,
          id.id,
          type: int,
          table: PlatformSystemRelationData.table,
        );
