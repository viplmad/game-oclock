...
import 'package:backend/entity/entity.dart' show DLCEntityData, DLCID, DLCPurchaseRelationData, PurchaseEntityData, PurchaseID;
...
class DLCPurchaseRelationQuery {
  ...
  static Query selectAllDLCsByPurchaseId(PurchaseID id) {
    final Query query = FluentQuery
      ...
      .where(DLCPurchaseRelationData.purchaseField, id.id, type: int, table: DLCPurchaseRelationData.table);
  ...
  static Query selectAllPurchasesByDLCId(DLCID id) {
    final Query query = FluentQuery
      ...
      .where(DLCPurchaseRelationData.dlcField, id.id, type: int, table: DLCPurchaseRelationData.table);
  ...
  static void _addIdWhere(DLCID dlcId, PurchaseID purchaseId, Query query) {
    query.where(DLCPurchaseRelationData.dlcField, dlcId.id, type: int, table: DLCPurchaseRelationData.table);
    query.where(DLCPurchaseRelationData.purchaseField, purchaseId.id, type: int, table: DLCPurchaseRelationData.table);
  }
}