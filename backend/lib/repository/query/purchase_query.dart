...
class PurchaseQuery {
  ...
  static Query deleteById(PurchaseID id) {
    final Query query = FluentQuery.delete().from(PurchaseEntityData.table);
  ...
  static Query selectById(PurchaseID id) {
    final Query query = FluentQuery.select().from(PurchaseEntityData.table);
  ...
  static Query selectFirstInView(PurchaseView view, int limit, [int? year]) {
    final Query query =
        FluentQuery.select().from(PurchaseEntityData.table).limit(limit);
  ...
  static Query selectAllByStore(StoreID id) {
    final Query query =
        FluentQuery.select().from(PurchaseEntityData.table).where(
              PurchaseEntityData.storeField,
              id.id,
              type: int,
              table: PurchaseEntityData.table,
            );
  ...
  static Query selectFirstInViewByDescriptionLike(
    PurchaseView view,
    String description,
    int limit, [
    int? year,
  ...
  static Query selectStoreByPurchase(PurchaseID id) {
    final Query query = FluentQuery.select()
        ...
        .join(
          ...
          null,
          PurchaseEntityData.storeField,
          StoreEntityData.table,
          StoreEntityData.idField,
        )
        .where(
  ...
  static void _completeView(Query query, PurchaseView view, int? year) {
    switch (view) {
      ...
      case PurchaseView.pending:
        ...
        final Query countGamePurchase = FluentQuery.select()
            .field(
        ...
        final Query countDLCPurchase = FluentQuery.select()
            .field(
