...
import 'package:backend/entity/entity.dart'
    show SystemEntity, SystemID, SystemEntityData, SystemView;
...
class SystemQuery {
  ...
  static Query deleteById(SystemID id) {
    final Query query = FluentQuery.delete().from(SystemEntityData.table);
  ...
  static Query selectById(SystemID id) {
    final Query query = FluentQuery.select().from(SystemEntityData.table);
  ...
  static Query selectFirstInView(SystemView view, int limit) {
    final Query query =
        FluentQuery.select().from(SystemEntityData.table).limit(limit);
