...
import 'package:backend/entity/entity.dart'
    show StoreEntity, StoreEntityData, StoreID, StoreView;
...
class StoreQuery {
  ...
  static Query deleteById(StoreID id) {
    final Query query = FluentQuery.delete().from(StoreEntityData.table);
  ...
  static Query selectById(StoreID id) {
    final Query query = FluentQuery.select().from(StoreEntityData.table);
  ...
  static Query selectFirstInView(StoreView view, int limit) {
    final Query query =
        FluentQuery.select().from(StoreEntityData.table).limit(limit);
