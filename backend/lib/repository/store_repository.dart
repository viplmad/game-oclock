...
import 'package:backend/entity/entity.dart'
    show PurchaseID, StoreEntity, StoreEntityData, StoreID, StoreView;
...
class StoreRepository extends ItemRepository<StoreEntity, StoreID> {
  ...
  ) : super(itemConnector, imageConnector, recordName: StoreEntityData.table);

  static const String _imagePrefix = 'icon';

  @override
  StoreEntity entityFromMap(Map<String, Object?> map) =>
      StoreEntity.fromMap(map);
  @override
  ...
  Future<List<StoreEntity>> findFirstWithViewByName(
    StoreView storeView,
    String name,
    int limit,
  ) {
    final Query query =
        StoreQuery.selectFirstInViewByNameLike(storeView, name, limit);
    return readItemList(
      query: query,
    );
  }
