...
class SystemMapper {
  ...
  static const Map<Manufacturer, String> manufacturerToStringMap =
      <Manufacturer, String>{
  ...
  static const Map<String, Manufacturer> stringToManufacturerMap =
      <String, Manufacturer>{
  ...
  static Future<System> futureEntityToModel(
    Future<SystemEntity> entityFuture,
  ...
  static Future<List<System>> futureEntityListToModelList(
    Future<List<SystemEntity>> entityListFuture,
    String? Function(String?) iconFunction,
  ) {
