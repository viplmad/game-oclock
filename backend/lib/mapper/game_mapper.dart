...
class GameMapper {
  ...
  static const Map<GameStatus, String> _statusToStringMap =
      <GameStatus, String>{
  ...
  static const Map<String, GameStatus> _stringToStatusMap =
      <String, GameStatus>{
  ...
  static Future<Game> futureEntityToModel(
    Future<GameEntity> entityFuture,
  ...
  static Future<List<Game>> futureEntityListToModelList(
    Future<List<GameEntity>> entityListFuture,
    String? Function(String?) coverFunction,
  ) {
