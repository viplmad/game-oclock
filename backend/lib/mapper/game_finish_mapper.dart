...
class GameFinishMapper {
  ...
  static Future<GameFinish> futureEntityToModel(Future<GameFinishEntity> entityFuture) {

    return entityFuture.asStream().map( entityToModel ).first;

  }

  static Future<List<GameFinish>> futureEntityListToModelList(Future<List<GameFinishEntity>> entityListFuture) {
