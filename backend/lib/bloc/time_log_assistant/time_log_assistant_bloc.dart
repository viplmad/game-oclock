...
class TimeLogAssistantBloc extends Bloc<TimeLogAssistantEvent, TimeLogAssistantState> {
  ...
  void _mapUpdateDateToState(UpdateTimeLogDate event, Emitter<TimeLogAssistantState> emit) {
  ...
  void _mapUpdateStartTimeToState(UpdateTimeLogStartTime event, Emitter<TimeLogAssistantState> emit) {
    ...
    if(endTime == null && duration != null) {
      ...
      final TimeLogRecalculationMode recalculationMode = state.recalculationMode;
  ...
  void _mapUpdateEndTimeToState(UpdateTimeLogEndTime event, Emitter<TimeLogAssistantState> emit) {
  ...
  void _mapUpdateDurationToState(UpdateTimeLogDuration event, Emitter<TimeLogAssistantState> emit) {
  ...
  void _mapUpdateModeToState(UpdateTimeLogRecalculationMode event, Emitter<TimeLogAssistantState> emit) {
