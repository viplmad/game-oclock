...
class PurchaseRelationManagerBloc<W extends Item>
    extends ItemRelationManagerBloc<Purchase, PurchaseID, W> {
  ...
  Future<Object?> addRelation(AddItemRelation<W> event) {
    ...
    switch (W) {
      ...
      case Store:
        final StoreEntity otherEntity =
            StoreMapper.modelToEntity(otherItem as Store);
        return storeRepository.relateStorePurchase(otherEntity.createId(), id);
      case PurchaseType:
        final PurchaseTypeEntity otherEntity =
            PurchaseTypeMapper.modelToEntity(otherItem as PurchaseType);
        return purchaseRepository.relatePurchaseType(
          id,
  ...
  Future<Object?> deleteRelation(DeleteItemRelation<W> event) {
    ...
    switch (W) {
      ...
      case PurchaseType:
        final PurchaseTypeEntity otherEntity =
            PurchaseTypeMapper.modelToEntity(otherItem as PurchaseType);
        return purchaseRepository.unrelatePurchaseType(
          id,
          otherEntity.createId(),
        );
    }
