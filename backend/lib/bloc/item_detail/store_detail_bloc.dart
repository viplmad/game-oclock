...
class StoreDetailBloc extends ItemDetailBloc<Store, StoreEntity, StoreID, StoreRepository> {
  StoreDetailBloc({
    required int itemId,
    required GameCollectionRepository collectionRepository,
    required StoreDetailManagerBloc managerBloc,
  }) : super(id: StoreID(itemId), repository: collectionRepository.storeRepository, managerBloc: managerBloc);
