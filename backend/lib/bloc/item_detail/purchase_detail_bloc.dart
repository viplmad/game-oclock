...
class PurchaseDetailBloc extends ItemDetailBloc<Purchase, PurchaseEntity, PurchaseID, PurchaseRepository> {
  PurchaseDetailBloc({
    required int itemId,
    required GameCollectionRepository collectionRepository,
    required PurchaseDetailManagerBloc managerBloc,
  }) : super(id: PurchaseID(itemId), repository: collectionRepository.purchaseRepository, managerBloc: managerBloc);
