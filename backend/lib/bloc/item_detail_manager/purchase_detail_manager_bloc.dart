...
class PurchaseDetailManagerBloc extends ItemDetailManagerBloc<Purchase, PurchaseEntity, PurchaseID, PurchaseRepository> {
  PurchaseDetailManagerBloc({
    required int itemId,
    required GameCollectionRepository collectionRepository,
  }) : super(id: PurchaseID(itemId), repository: collectionRepository.purchaseRepository);
  ...
  Future<Purchase> updateFuture(UpdateItemField<Purchase> event) {
    ...
    final PurchaseEntity updatedEntity = PurchaseMapper.modelToEntity(event.updatedItem);
    final Future<PurchaseEntity> entityFuture = repository.update(entity, updatedEntity);
