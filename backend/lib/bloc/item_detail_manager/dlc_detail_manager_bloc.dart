...
class DLCDetailManagerBloc extends ItemDetailManagerBloc<DLC, DLCEntity, DLCID, DLCRepository> {
  ...
  Future<DLC> updateFuture(UpdateItemField<DLC> event) {
    ...
    final Future<DLCEntity> entityFuture = repository.update(entity, updatedEntity);
