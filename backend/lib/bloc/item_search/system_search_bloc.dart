import 'package:backend/entity/entity.dart'
    show SystemEntity, SystemID, SystemView;
...
class SystemSearchBloc extends ItemRemoteSearchBloc<System, SystemEntity,
  ...
  Future<List<System>> getInitialItems() {
    final SystemView view = viewIndex != null
        ? SystemView.values[viewIndex!]
        : SystemView.lastCreated;
