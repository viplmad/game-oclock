import 'package:backend/entity/entity.dart'
    show PurchaseTypeEntity, PurchaseTypeID, PurchaseTypeView;
...
class PurchaseTypeSearchBloc extends ItemRemoteSearchBloc<PurchaseType,
  ...
  Future<List<PurchaseType>> getInitialItems() {
    final PurchaseTypeView view = viewIndex != null
        ? PurchaseTypeView.values[viewIndex!]
        : PurchaseTypeView.lastCreated;
