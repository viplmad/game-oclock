...
class PlatformSearchBloc extends ItemRemoteSearchBloc<Platform, PlatformEntity,
  ...
  Future<List<Platform>> getInitialItems() {
    final PlatformView view = viewIndex != null
        ? PlatformView.values[viewIndex!]
        : PlatformView.lastCreated;
