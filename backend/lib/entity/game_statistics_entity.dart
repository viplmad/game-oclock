...
import 'entity.dart'
    show GameEntityData, GameFinishEntityData, GameTimeLogEntityData;
...
class GameStatisticsEntity extends Equatable {
  ...
  static GameStatisticsEntity fromMap(
    Map<String, Object?> map,
    Map<String, Object?> finishMap,
    Map<String, Object?> timeLogMap,
  ) {
    return GameStatisticsEntity(
      ...
      minReleaseYear:
          (map[GameStatisticsData.minReleaseYearField] as int?) ?? 0,
      maxReleaseYear:
          (map[GameStatisticsData.maxReleaseYearField] as int?) ?? 0,
      lowPriorityCount:
          (map[GameStatisticsData.lowPriorityCountField] as int?) ?? 0,
      ...
      finishCount:
          (finishMap[GameStatisticsData.finishCountField] as int?) ?? 0,
      minFinishDate:
          (finishMap[GameStatisticsData.minFinishDateField] as DateTime?) ??
              DateTime.now(),
      maxFinishDate:
          (finishMap[GameStatisticsData.maxFinishDateField] as DateTime?) ??
              DateTime.now(),
      timeLogSum:
          (timeLogMap[GameStatisticsData.timeLogSumField] as Duration?) ??
              const Duration(),
    );
  }

  static Map<int, T> mapToYearMap<T>(Map<String, Object?> map, T valueIfNull) {
    return map.map<int, T>(
      (String key, Object? value) =>
          MapEntry<int, T>(int.parse(key), (value as T?) ?? valueIfNull),
    );
  }
...
class GameGeneralStatisticsEntity extends GameStatisticsEntity {
  ...
  static GameGeneralStatisticsEntity fromMap(
    GameStatisticsEntity stats,
    Map<String, Object?> countByReleaseYearMap,
    Map<String, Object?> countByRatingMap,
    Map<String, Object?> avgRatingByFinishYearMap,
    Map<String, Object?> countByFinishYearMap,
    Map<String, Object?> timeLogSumByFinishYearMap,
  ) {
    return GameGeneralStatisticsEntity(
      ...
      countByReleaseYear:
          GameStatisticsEntity.mapToYearMap<int>(countByReleaseYearMap, 0),
      countByRating:
          GameStatisticsEntity.mapToYearMap<int>(countByRatingMap, 0),
      avgRatingByFinishYear: GameStatisticsEntity.mapToYearMap<double>(
        avgRatingByFinishYearMap,
        0.0,
      ),
      countByFinishYear:
          GameStatisticsEntity.mapToYearMap<int>(countByFinishYearMap, 0),
      timeLogSumByFinishYear: GameStatisticsEntity.mapToYearMap<Duration>(
        timeLogSumByFinishYearMap,
        Duration.zero,
      ),
    );
  }
...
class GameYearStatisticsEntity extends GameStatisticsEntity {
  ...
  static GameYearStatisticsEntity fromMap(
    GameStatisticsEntity stats,
    Map<String, Object?> countByReleaseYearMap,
    Map<String, Object?> countByRatingMap,
    Map<String, Object?> timeLogSumByMonthMap,
  ) {
    return GameYearStatisticsEntity(
      ...
      countByRating:
          GameStatisticsEntity.mapToYearMap<int>(countByRatingMap, 0),
      timeLogSumByMonth: GameStatisticsEntity.mapToYearMap<Duration>(
        timeLogSumByMonthMap,
        Duration.zero,
      ),
    );
  }
