...
abstract class WhereValueNode extends WhereNode {
  ...
  ) : super(operator, divider, combiner);
...
class WhereFieldValueNode extends WhereValueNode {
  WhereFieldValueNode(
    ...
    DividerType divider,
    CombinerType combiner,
  ) : super(value, operator, divider, combiner);

  final FieldStringNode field;
}

class WhereFieldDatePartNode extends WhereFieldValueNode {
  WhereFieldDatePartNode(
    FieldStringNode field,
    int value,
    this.datePart,
    OperatorType operator,
    DividerType divider,
    CombinerType combiner,
  ) : super(field, value, operator, divider, combiner);
