...
class StatisticsHistogram<N extends num> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Series<_SeriesElement<N>, String> series =
        Series<_SeriesElement<N>, String>(
      id: histogramName,
      colorFn: (_, __) =>
      ...
      labelAccessorFn: (_SeriesElement<N> element, _) =>
          labelAccessor(element.value),
    );

    final List<Series<_SeriesElement<N>, String>> seriesList =
        <Series<_SeriesElement<N>, String>>[series];
    ...
    return BarChart(
      ...
      domainAxis: hideDomainLabels
          ? const OrdinalAxisSpec(renderSpec: NoneRenderSpec<String>())
