...
class SimpleYearPicker extends StatefulWidget {
  ...
  @override
  _SimpleYearPickerState createState() => _SimpleYearPickerState();
}

class _SimpleYearPickerState extends State<SimpleYearPicker> {
