...
class SingleCalendarBloc extends Bloc<SingleCalendarEvent, SingleCalendarState> {
  ...
  Stream<SingleCalendarState> _mapUpdateSelectedDateToState(UpdateSelectedDate event) async* {
    ...
    if(state is CalendarLoaded) {
      final List<GameTimeLog> timeLogs = (state as CalendarLoaded).timeLogs;
      final Set<DateTime> logDates = (state as CalendarLoaded).logDates;
      final List<GameFinish> finishDates = (state as CalendarLoaded).finishDates;
      ...
      List<GameTimeLog> selectedTimeLogs = (state as CalendarLoaded).selectedTimeLogs;
  ...
  void _mapAddedFinishDateToEvent(RelationAdded<GameFinish> managerState) {
    ...
    if(state is CalendarLoaded) {
      ...
      final List<GameFinish> finishDates = (state as CalendarLoaded).finishDates;
      final DateTime selectedDate = (state as CalendarLoaded).selectedDate;
      final List<GameTimeLog> selectedTimeLogs = (state as CalendarLoaded).selectedTimeLogs;
