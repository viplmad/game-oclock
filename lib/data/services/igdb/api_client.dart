...
class ApiClient {
  ApiClient({this.basePath = 'https://api.igdb.com/v4', this.authentication});
  ApiClient.auth({
    this.basePath = 'https://id.twitch.tv/oauth2',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'IGDBGame':
          return IGDBGame.fromJson(value);
        default:
          dynamic match;
          if (value is List &&
          ...
          if (value is Map &&
              (match = regMap.firstMatch(targetType)?.group(1)) != null) {
